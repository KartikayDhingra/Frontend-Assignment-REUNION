...
const Rent = () => {
  ...
  return (
    <div className="px-40 py-24">
      ...
      <div className="mt-10 flex items-center justify-between flex-wrap gap-x-10 gap-y-20 items-stretch">
        {places.length === 0 ? <h1>No results found...</h1> : places.map((place) => {
          return (
            <PropertyCard
              key={place.id}
              image={place.image}
